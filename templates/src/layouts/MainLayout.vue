<template>
  <q-layout view="lHh Lpr lFf">
    <q-header style="background-color:#1370ee;height: 110px;display: flex;">
      <q-toolbar style="align-self:center;">
        ...
        <q-toolbar-title style="font-size: 20px;font-weight: bold;max-width: 8.85%">
          {{ $t('index.title') }}
        </q-toolbar-title>
        <q-btn-group flat style="margin-left: 20.83%">
          <q-btn :label=navbar.front_page style="font-size: 16px;"></q-btn>
          <q-btn :label=navbar.community style="font-size: 16px;"></q-btn>
          <q-btn :label=navbar.market style="font-size: 16px;"></q-btn>
          <q-btn-dropdown :label=navbar.dome>
            <q-list>
...
export default defineComponent({
  ...
  methods: {
    frontpage () {
      window.open('https://production.56yhz.com/#/')
    },
    langChange (e) {
      var _this = this
      _this.lang = e
    ...
    ios () {
      window.open('http://www.quasarchs.com/vue-components/button/')
    },
    android () {
      window.open('http://www.quasarchs.com/vue-components/button/')
    },
